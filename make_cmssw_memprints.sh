...
#
##update L1FPGATrackProducer (is this still needed?)
##sed -i 's/trackQuality_ = iConfig\.getParameter<bool>("TrackQuality");/trackQuality_ = iConfig\.getParameter<bool>("TrackQuality");\n  trackQuality_ = false; \/\/change to avoid weird crash/g' L1Trigger/TrackFindingTracklet/plugins/L1FPGATrackProducer.cc
#
